...
public class DemoPerspective implements IPerspectiveFactory {
    ...
    public void createInitialLayout(IPageLayout layout) {
        ...
        IFolderLayout right = layout.createFolder("right", IPageLayout.RIGHT, 0.1f, editorArea);
        right.addView("com.innotree.rap.demo.views.form");
        right.addView("com.innotree.rap.demo.views.chart");

        // 3. 하단: Table View + Selection View
        // 남은 60%에서 하단이 40%가 되도록: 0.4f
        IFolderLayout bottom = layout.createFolder("bottom", IPageLayout.TOP, 0.9f, editorArea);
